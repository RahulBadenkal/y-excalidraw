...
## Note
The sync is at the array item level but not at the item key level. Even the excalidraw SaaS offering doesn't support that ([Link here](https://blog.excalidraw.com/building-excalidraw-p2p-collaboration-feature/)). It would b not be very hard to add it here but there are 2 issues that might crop up
